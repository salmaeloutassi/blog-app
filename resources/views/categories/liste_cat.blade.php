...
<div class="py-12  mx-64">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class=" overflow-hidden  p-6 text-gray-900">
            <h1 class="text-xl text-gray-700">liste des categories</h1>
            <button
            type="button"
                  ...
                  <table class="min-w-full text-left text-sm font-light">
                    <thead
                      ...
                      <tr>
                        ...
                        <th scope="col" class="px-6 py-4">dtae de modification</th>
                    ...
                    @foreach ($categories as $category)
                      <tr
                        ...
                        <td class="flex space-x-4  whitespace-nowrap text-base px-6 py-4">
                            <a class="font-medium text-primary-600" href="{{ route('categories.edit', $category->id) }}">edit</a>
                            <div x-data="{ showModal: false }">
                              ...
                              <form action="{{ route('categories.destroy', $category->id) }}" method="POST"
                                  ...
                                  @csrf
                                  @method('DELETE')
                                  <a href="#" onclick="toggleModal('modal-id{{ $category->id }}')" class="font-medium text-red-600 ">Delet</a>
                                  <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                                      ...
                                      <div class="relative rounded-lg shadow-lg  w-[500px] bg-white my-6 mx-auto max-w-3xl">
                                          ...
                                          <div
                                              ...
                                              onclick="toggleModal('modal-id{{ $category->id }}')">
                                              <span
